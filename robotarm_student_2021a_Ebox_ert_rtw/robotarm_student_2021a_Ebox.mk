...
## Generated on : Mon Feb 24 15:17:48 2025
...
MAKEFILE                  = robotarm_student_2021a_Ebox.mk
MATLAB_ROOT               = $(MATLAB_WORKSPACE)/Applications/MATLAB_R2021a.app
MATLAB_BIN                = $(MATLAB_WORKSPACE)/Applications/MATLAB_R2021a.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maci64
START_DIR                 = $(MATLAB_WORKSPACE)/Users/philipp/Downloads/robot/robotarm_student
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_WORKSPACE)/Users/philipp/Documents/MATLAB/SupportPackages/R2021a/toolbox/target/shared/svd/include -I$(START_DIR)/robotarm_student_2021a_Ebox_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_WORKSPACE)/Users/philipp/Documents/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/raspi/include -I$(MATLAB_ROOT)/toolbox/target/codertarget/rtos/inc
...
ec_Ebox.c.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_Ebox.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_EboxResetEnc.c.o : $(START_DIR)/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_EboxResetEnc.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
MW_raspi_init.c.o : $(MATLAB_WORKSPACE)/Users/philipp/Documents/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/raspi/src/MW_raspi_init.c
	$(CC) $(CFLAGS) -o "$@" "$<"


MW_Pyserver_control.c.o : $(MATLAB_WORKSPACE)/Users/philipp/Documents/MATLAB/SupportPackages/R2021a/toolbox/realtime/targets/raspi/src/periphs/MW_Pyserver_control.c
	$(CC) $(CFLAGS) -o "$@" "$<"
