...
## Generated on : Wed Mar 26 12:03:42 2025
...
%.c.o : $(START_DIR)/Simulink/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/Simulink/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/Simulink/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
getSystemClockTimeval_wrapper.c.o : $(START_DIR)/Simulink/getSystemClockTimeval_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"
