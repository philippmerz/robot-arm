...
struct P_robotarm_student_2021a_Ebox_T_ {
  ...
  real_T UnitDelay_InitialCondition;   /* Expression: 0
                                        ...
                                        */
  real_T set_robot_calibration_r_Value;/* Expression: 1.3063
  ...
  real_T Constant_Value_n;             /* Expression: -0.1
                                        ...
                                        */
  real_T set_robot_calibration_x_Value;/* Expression: 0.6519
  ...
  real_T Constant_Value_p;             /* Expression: 0.1
                                        ...
                                        */
  real_T set_robot_calibration_z_Value;/* Expression: -0.391
