  ...
  ;%***********************
    ...
    ;%
      section.nData     = 346;
      section.data(346)  = dumData; %prealloc
	  ...
	  section.data(95).dtTransOffset = 128;
	  ...
	  section.data(117).dtTransOffset = 159;
	  ...
	  section.data(166).dtTransOffset = 217;
	
	  ;% robotarm_student_2021a_Ebox_P.ec_Ebox_P1_Size_du
	  section.data(167).logicalSrcIdx = 166;
	  section.data(167).dtTransOffset = 218;
	  ...
	  section.data(191).dtTransOffset = 243;
	
	  ;% robotarm_student_2021a_Ebox_P.EnableVentiel_Value
	  section.data(192).logicalSrcIdx = 191;
	  section.data(192).dtTransOffset = 244;
	  ...
	  section.data(195).dtTransOffset = 254;
	  ...
	  section.data(199).dtTransOffset = 260;
	  ...
	  section.data(201).dtTransOffset = 263;
	  ...
	  section.data(205).dtTransOffset = 269;
	  ...
	  section.data(209).dtTransOffset = 275;
	
	  ;% robotarm_student_2021a_Ebox_P.Dctleadlag_P1_Size_n
	  section.data(210).logicalSrcIdx = 209;
	  section.data(210).dtTransOffset = 276;
	  ...
	  section.data(229).dtTransOffset = 304;
	
	  ;% robotarm_student_2021a_Ebox_P.Dctleadlag_P3_Size_j
	  section.data(230).logicalSrcIdx = 229;
	  section.data(230).dtTransOffset = 305;
	  ...
	  section.data(233).dtTransOffset = 310;
  ...
  targMap.checksum0 = 3493206624;
  targMap.checksum1 = 2983137211;
  targMap.checksum2 = 3595612033;
  targMap.checksum3 = 2888533355;
