  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% robotarm_student_2021a_Ebox_P.PulseGenerator2_Amp
	  section.data(59).logicalSrcIdx = 58;
	  section.data(59).dtTransOffset = 69;
	
	  ;% robotarm_student_2021a_Ebox_P.PulseGenerator2_Period
	  ...
	  ;% robotarm_student_2021a_Ebox_P.PulseGenerator2_PhaseDelay
	  ...
	  section.data(91).dtTransOffset = 105;
	  ...
	  section.data(134).dtTransOffset = 168;
	
	  ;% robotarm_student_2021a_Ebox_P.Dctnotch_P3_Size_l
	  section.data(135).logicalSrcIdx = 134;
	  section.data(135).dtTransOffset = 169;
	  ...
	  section.data(141).dtTransOffset = 178;
	  ...
	  section.data(202).dtTransOffset = 253;
	
	  ;% robotarm_student_2021a_Ebox_P.Gain2_Gain_d
	  section.data(203).logicalSrcIdx = 202;
	  section.data(203).dtTransOffset = 254;
	
	  ;% robotarm_student_2021a_Ebox_P.ec_Ebox_P1_Size_du
	  section.data(204).logicalSrcIdx = 203;
	  section.data(204).dtTransOffset = 255;
	  ...
	  section.data(252).dtTransOffset = 321;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% robotarm_student_2021a_Ebox_DW.label_picker
	  section.data(22).logicalSrcIdx = 48;
	  section.data(22).dtTransOffset = 29;
	
	  ;% robotarm_student_2021a_Ebox_DW.item_tracker
	  ...
	  ;% robotarm_student_2021a_Ebox_DW.clockTickCounter_h
	  section.data(7).logicalSrcIdx = 90;
	  section.data(7).dtTransOffset = 6;
	
	  ;% robotarm_student_2021a_Ebox_DW.clockTickCounter_j
	  ...
	  ;% robotarm_student_2021a_Ebox_DW.temporalCounter_i1_ac
  ...
  targMap.checksum0 = 2808529245;
  targMap.checksum1 = 3336911479;
  targMap.checksum2 = 786260728;
  targMap.checksum3 = 3847185519;
