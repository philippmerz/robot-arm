...
## Generated on : Thu Mar 27 14:10:03 2025
...
START_DIR                 = $(MATLAB_WORKSPACE)/C/Users/ptrze/OneDrive/Documents/GitHub/robot-arm/tooling
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
%.c.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/tooling/calibration/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/tooling/calibration/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/tooling/calibration/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.c.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"


%.cpp.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
dleadlag.c.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dleadlag.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dlowpass1.c.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dlowpass1.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dnotch.c.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dnotch.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dpd.c.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dpd.c
	$(CC) $(CFLAGS) -o "$@" "$<"


dweakint.c.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/dweakint.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_Ebox.c.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_Ebox.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_EboxResetEnc.c.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_EboxResetEnc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ec_Supervisor.c.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/SPERTE/SPERTE_installation/Tooling/Simulink_Lib/SPERTE_Blocks/sfunctions/ec_Supervisor.c
	$(CC) $(CFLAGS) -o "$@" "$<"


getSystemClockTimeval_wrapper.c.o : $(MATLAB_WORKSPACE)/C/Users/ptrze/Technical_University_Eindhoven/Y3_Q3/Robot_Arm/canvas_downloads/robotarm_student/tooling/calibration/getSystemClockTimeval_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"
