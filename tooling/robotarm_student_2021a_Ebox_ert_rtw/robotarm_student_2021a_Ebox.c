  ...
  if (robotarm_student_2021a_Ebox_DW.is_active_Vacuum != 0U) {
    switch (robotarm_student_2021a_Ebox_DW.is_Vacuum) {
     case robotarm_student_20_IN_AirBurst:
      if (robotarm_student_2021a_Ebox_DW.temporalCounter_i1_c >= 1024U) {
     ...
     case robotarm_student_2_IN_Vacuum_On:
      if (robotarm_student_2021a_Ebox_DW.sfEvent_b ==
        ...
        robotarm_student_2021a_Ebox_DW.temporalCounter_i1_c = 0U;
...
void robotarm_student_2021a_Ebox_step(void)
{
  ...
  if (robotarm_student_2021a_Ebox_DW.Controller_MODE) {
    ...
    if (robotarm_student_2021a_Ebox_DW.isNotInit) {
      if (robotarm_student_2021a_Ebox_DW.temporalCounter_i1_c < 2047U) {
...
void robotarm_student_2021a_Ebox_initialize(void)
{
  ...
  /* External mode info */
  robotarm_student_2021a_Ebox_M->Sizes.checksums[0] = (3230858663U);
  robotarm_student_2021a_Ebox_M->Sizes.checksums[1] = (2044363411U);
  robotarm_student_2021a_Ebox_M->Sizes.checksums[2] = (1322494052U);
  robotarm_student_2021a_Ebox_M->Sizes.checksums[3] = (743419615U);
